Я занимаюсь разработкой Cloud Native решений на Python, у меня достаточно большой опыт работы DevOps инженером (5 лет), работаю в основном с GoogleCloud, но так же имеется опыт с AWS и Azure. 
